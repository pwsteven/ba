 ...
 */
final class Version20191205162430 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE bacorrespondence (id INT AUTO_INCREMENT NOT NULL, user_id_id INT NOT NULL, received_confirmation_email VARCHAR(255) DEFAULT NULL, breach_one_date VARCHAR(255) DEFAULT NULL, breach_one_notification VARCHAR(255) DEFAULT NULL, breach_one_date_received DATE DEFAULT NULL, breach_one_notification_file_path VARCHAR(255) DEFAULT NULL, breach_one_notification_not_affected VARCHAR(255) DEFAULT NULL, breach_one_date_of_booking DATE DEFAULT NULL, breach_one_email_address_used VARCHAR(255) DEFAULT NULL, breach_one_booking_reference VARCHAR(255) DEFAULT NULL, breach_one_booking_platform VARCHAR(255) DEFAULT NULL, breach_one_payment_method VARCHAR(255) DEFAULT NULL, breach_one_booking_confirmation_file_path VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_522442CD9D86650F (user_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('ALTER TABLE bacorrespondence ADD CONSTRAINT FK_522442CD9D86650F FOREIGN KEY (user_id_id) REFERENCES user (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE bacorrespondence');
